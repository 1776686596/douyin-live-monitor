...
> ⚠️ **重要声明：本项目仅供学习和技术研究目的，请在使用前仔细阅读下方免责声明。**
...
**本项目仅供学习、研究和技术交流目的。在下载、安装、使用本项目之前，请您仔细阅读以下声明：**

#### 1. 使用目的限制

- 本项目仅供个人学习 Python 编程、Web 爬虫技术、FastAPI 框架等技术研究使用
- **严禁**将本项目用于任何商业目的
- **严禁**将本项目用于任何违反法律法规的活动
- **严禁**将采集的数据用于出售、交易或其他商业行为
...
- 网络爬虫可能违反目标网站的服务条款（ToS）
- 过度采集可能导致 IP 被封禁或账号被限制
- 采集的数据可能涉及他人隐私，需谨慎处理
- 本项目的使用可能存在法律风险，使用者需自行评估

#### 4. 免责条款

- **作者不对使用本项目产生的任何直接或间接损失承担责任**
- **作者不对因使用本项目而导致的任何法律纠纷承担责任**
- **作者不对本项目的可用性、准确性或完整性作任何保证**
- 本项目按"现状"提供，不提供任何明示或暗示的担保
- 使用本项目即表示您已理解并同意自行承担所有风险

#### 5. 数据处理声明

- 本项目采集的数据仅应存储在本地，不应上传至任何第三方服务器
- 用户应在学习研究完成后及时删除采集的数据
- 用户不得将采集的数据用于用户画像、精准营销等目的
- 涉及个人信息的数据应按照相关法律法规进行脱敏处理
...
1. 仅在本地环境进行技术学习和测试
2. 控制采集频率，避免对目标服务器造成压力
3. 不要采集、存储或传播任何个人隐私信息
4. 学习完成后及时删除相关数据和程序
5. 如有疑问，请咨询专业法律人士

---

**继续使用本项目即表示您已阅读、理解并同意上述所有条款。如果您不同意上述任何条款，请立即停止使用并删除本项目。**